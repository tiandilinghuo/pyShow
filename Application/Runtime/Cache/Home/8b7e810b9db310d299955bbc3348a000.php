...
<head>
    ...
    <script>
        ...
        function  tryTest(){
            ...
            $(this).attr("style","background-color: #e6e4e5");
           seeMostSim(pd);
            seeLetter(pd);
           seePar(pd);
        }
            ...
            $.ajax( {
                ...
                success : function(data){
                    if(data.code==0){
                        ...
                        $("#top3").append(ti);
                        for(var ii=0;ii<ret.length;ii++){
                            tt="<dd><span>"+ret[ii].sen+"</span><span>"+ret[ii].score+"</span></dd>";
                            $("#top3").append(tt);
                        }
                    }
        ...
        <div class="right">
            <div class="test-centent">
                ...
                <dl class="plus" id="userSample">
                    <dd><em>句1</em><span style="background-color: #5cb85c">这是我输入的内容1这是我输入的内容1这是我输入的内容1这是我输入的内容1</span></dd>
                    <dd><em>句2</em><span>这是我输入的内容2这是我输入的内容1这是我输入的内容1这是我输入的内容1这是我输入的内容2这是我输入的内容1这是我输入的内容1这是我输入的内容1这我输入的内容1</span></dd>
                    <dd><em>句3</em><span>这是我输入的内容3这是我输入的内容1这是我输入的内容1这是我输入的内容1</span></dd>
                    <dd><em>句4</em><span>这是我输入的内容4这是我输入的内容1这是我输入的内容1这是我输入的内容1</span></dd>
                    <dd><em>句5</em><span>这是我输入的内容1这是我输入的内容1这是我输入的内容1这是我输入的内容1</span></dd>
                    <dd><em>句6</em><span>这是我输入的内容2这是我输入的内容1这是我输入的内容1这是我输入的内容1这是我输入的内容2这是我输入的内容1这是我输入的内容1这是我输入的内容1这是我输入的内容1</span></dd>
                    <dd><em>句7</em><span>这是我输入的内容3这是我输入的内容1这是我输入的内容1这是我输入的内容1</span></dd>
                    <dd><em>句8</em><span>这是我输入的内容4这是我输入的内容1这是我输入的内容1这是我输入的内容1</span></dd>
                </dl>
                <div class="plus-show">
                    <textarea id="addSen" class="text" ></textarea><input type="button" id="addtest" class="plus-btn" value="添加">
